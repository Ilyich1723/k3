...
abstract class $PostsCopyWith<$Res> {
  ...
  @useResult
  $Res call({int userId, List<String> tags});
}
...
class _$PostsImpl implements _Posts {
  _$PostsImpl({required this.userId, required final List<String> tags})
      : _tags = tags;
  ...
  @override
  String toString() {
    return 'Posts(userId: $userId, tags: $tags)';
  }
...
abstract class _Posts implements Posts {
  factory _Posts(
      ...
      required final List<String> tags}) = _$PostsImpl;
